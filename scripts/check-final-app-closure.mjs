...
assert.match(roadmap, /Personas y Configuración como proyecciones acotadas del workspace/)
assert.match(roadmap, /Personas y Configuración cierran la arquitectura autenticada/)
