...
assert.match(evaluatorMigration, /assignment_key := encode\(extensions[.]digest/)
assert.match(evaluatorMigration, /first_detected_at/)
assert.match(evaluatorMigration, /last_evaluated_at/)
