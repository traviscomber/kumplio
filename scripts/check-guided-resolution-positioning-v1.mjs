...
assert.match(caseEntry, /DRAFT_STORAGE_KEY = 'kumplio:case-draft'/)
assert.match(caseEntry, /sessionStorage\.getItem\(DRAFT_STORAGE_KEY\)/)
assert.match(caseEntry, /sessionStorage\.removeItem\(DRAFT_STORAGE_KEY\)/)
