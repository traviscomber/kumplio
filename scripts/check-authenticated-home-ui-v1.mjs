...
for (const forbidden of ['Impacto máximo', 'escala interna 0–100', 'engineVersion', 'Score {priority.score}', '/sign-in?next=/dashboard', "'/review-center'"]) {
  if (source.includes(forbidden)) throw new Error(`Authenticated home exposes forbidden legacy or technical surface: ${forbidden}`)
}
