...
for (const marker of ['buildAuthenticatedHomeModel', 'selectedCaseId', 'initialDiagnosis', 'Estado actual', 'Tu única decisión ahora', 'Prioridades actuales', 'Casos activos', 'Cambios relevantes', 'resolveInitialActionHref']) {
...
const hierarchy = ['Estado actual', 'Tu única decisión ahora', 'Prioridades actuales', 'Casos activos', 'Cambios relevantes']
let cursor = -1
...
assert.equal(source.split('Tu única decisión ahora').length - 1, 1, 'Home must render one dominant next-action section')
