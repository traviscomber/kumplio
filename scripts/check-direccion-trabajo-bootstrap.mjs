...
assert.match(entrypoint, /direccion-trabajo-doctrina-v2/)
assert.match(entrypoint, /record_regulatory_source_capture/)
assert.match(entrypoint, /record_regulatory_parser_revision/)
...
assert.match(core, /direccion-trabajo-doctrina-v2/)
...
assert.match(core, /SANTIAGO,\?\\s\*\\d/)
assert.match(core, /MAT\./)
assert.match(core, /deterministic_text_relation_v2/)
