...
export const HOME_CLARITY_COPY: Record<PublicLocale, HomeClarityCopy> = {
  es: {
    ...
    specialists: {
      ...
      title: 'Siete especialistas coordinados. Una sola ruta de trabajo.',
      description: 'Kumplio activa la especialidad necesaria sin obligarte a coordinar agentes ni repartir el contexto manualmente.',
      people: [
        ...
        { name: 'Tomás', label: 'Datos', description: 'Ordena tratamientos, sistemas, terceros y responsabilidades.' },
        { name: 'Martina', label: 'Laboral', description: 'Conecta personas, documentos y obligaciones transversales.' },
        { name: 'Matías', label: 'Contratos', description: 'Relaciona compromisos contractuales, proveedores y evidencia.' },
        { name: 'Antonia', label: 'Operación', description: 'Aterriza los requisitos al trabajo real de cada industria.' },
      ],
      note: 'No son siete chatbots aislados: trabajan sobre el mismo caso y la decisión final permanece bajo control humano.',
    },
    scenarios: {
  ...
  en: {
    ...
    specialists: {
      ...
      title: 'Seven coordinated specialists. One work path.',
      description: 'Kumplio activates the expertise required without making you coordinate agents or distribute context manually.',
      people: [
        ...
        { name: 'Tomás', label: 'Data', description: 'Organizes processing activities, systems, third parties and ownership.' },
        { name: 'Martina', label: 'Labor', description: 'Connects people, documents and cross-cutting obligations.' },
        { name: 'Matías', label: 'Contracts', description: 'Connects contractual commitments, vendors and evidence.' },
        { name: 'Antonia', label: 'Operations', description: 'Grounds requirements in the real work of each industry.' },
      ],
      note: 'They are not seven isolated chatbots: they work on the same case, and the final decision remains under human control.',
    },
    scenarios: {
