  ...
  return (
    <div className="rounded-[28px] border border-white/12 bg-[#151c28] p-5 shadow-[0_30px_100px_rgba(0,0,0,0.45)] sm:p-7">
      ...
      <label htmlFor="resolution-goal" className="mt-6 block text-sm font-bold text-white">
        ¿Qué necesitas proteger o resolver?
      </label>
      <textarea
        id="resolution-goal"
        value={goal}
      ...
      >
        Empezar con guía experta <ArrowRight className="ml-2 h-4 w-4" />
      </button>

      <p className="mt-4 text-center text-xs leading-5 text-white/38">
        Kumplio centraliza los antecedentes, activa los especialistas adecuados y conserva el respaldo de cada decisión.
      </p>
    </div>
  )
}
